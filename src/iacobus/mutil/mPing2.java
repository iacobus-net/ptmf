...
//==========================================================================
    ...
    * Constructor
    */
    public mPing2(String dirIPMulticast, String puerto,String ttl) throws IOException
    {
    System.out.println("");
    System.out.println("");
    System.out.println("mPing2 v1.0");
...
//==========================================================================
    ...
    */
    ...
    System.out.println("Uso: java mtest.mPing2 <dir. ip multicast> <puerto> <ttl>");
    System.out.println("");
    System.out.println("");
    }
    ...
    */
    ...
    /**
      ...
      */
      ...
      try
      {
          mPing2 mping = new mPing2(args[0],args[1],args[2]);
          mping.run();
      }
