...
import net.iacobus.ptmf.DatagramSocketPTMF;
import net.iacobus.ptmf.ID_Socket;
import net.iacobus.ptmf.ID_SocketInputStream;
...
/**
 * FTPMulticast operativo versión 1.0 en modo texto para pruebas de consola
...
*/
 ...
 public void actionPTMFIDGL(PTMFEventIDGL evento)
 {
    ...
    if( evento.esAñadido())
    {
       //Log.log("IDGLS: "+FTPMulticast.getFTP().idgls,"");
 ...
 public void actionPTMFID_Socket(PTMFEventID_Socket evento)
 {
    ...
    if( evento.esAñadido())
    {
       //Log.log("ID_Sockets: "+FTPMulticast.getFTP().id_sockets,"");
   ...
   */
   void sendFile() throws IOException
   {
     ...
     try
     {
          ...
          Log.log(mn,"Iniciando transferencia FTPMulticast....");
