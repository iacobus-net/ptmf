...
//==========================================================================
 /**
  * Recibir Identificador de FTPMulticast PTMF v1.0
  * @return true si se ha recibido el Identificador de FTPMulticast, false en caso contrario
  */
 private boolean receiveIDFTPMulticast() throws IOException
 {
   ...
   try
   {
      ...
      Log.log("Iniciando la recepción FTPMulticast...","");
