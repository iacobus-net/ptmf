...
//------------------------------------------------------------
//
//	File: PTMFIDGLListener.java  1.0 24/9/99
//
//
//	Description: Clase PTMFIDGLListener.
//
// 	Authors: 
...
/**
 * Interfaz PTMFDatosRecibidosListener.
 * Notificación de eventos PTMFEventDatosRecibidos<br>
...
public interface PTMFDatosRecibidosListener
{
  //==========================================================================
  /**
   * El método callback
   * @param evento PTMFEventDatosRecibidos
   */
